    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://quizze-1.onrender.com/api/quiz`
        );
    ...
    <div className={style.main}>
      <div className={style.data}>
        <div className={style.box}>
          ...
          <h2 style={{ color: "green", textAlign: "center", marginTop: "0px" }}>
            Quiz Created
          </h2>
        </div>
        <div className={style.box}>
          ...
          <h2
            style={{ color: "orange", textAlign: "center", marginTop: "0px" }}
          >
            Question Created
          </h2>
        </div>
        <div className={style.box}>
          <h2
            style={{ color: "blue", textAlign: "center", marginBottom: "0px" }}
          >
            {impressions}
          </h2>
          <h2 style={{ color: "blue", textAlign: "center", marginTop: "0px" }}>
            Impression Created
          </h2>
        </div>
      </div>
