              ...
              {questions.map((_, index) => (
                <div
                  className={`${style.circle} ${
                    index === selectedCircle ? style.selected : ""
                  }`}
                  onClick={() => {
            ...
            <div className={style.opt}>
              ...
              {option === "quiz_type" && (
                <div className={style.timer}>
                  ...
                  <button
                    className={
                      selectedTimer === "off" ? style.timhover : style.tim
                    }
                    onClick={() => {
                  ...
                  <button
                    className={
                      selectedTimer === "5sec" ? style.timhover : style.tim
                    }
                    onClick={() => {
                  ...
                  <button
                    className={
                      selectedTimer === "10sec" ? style.timhover : style.tim
                    }
                    onClick={() => {
